...
const QuestionsInJs = () => {
  ...
  const codeStringResultSecond = 'const resultSecond = myArray.reduce((x,y) => (x > y) ? x : y);';
  ...
  return (
    <div> 
      ...
      <div>
        <section>
          <h2>
            1ère solution: utiliser Math
          </h2>          
          <SyntaxHighlighter language="javascript" style={dracula} wrapLines={true}>
